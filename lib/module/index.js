...
import Animated, { useAnimatedStyle, useDerivedValue, useSharedValue, withTiming, withDecay, useAnimatedReaction, withSpring, cancelAnimation } from 'react-native-reanimated';
...
const GalleryComponent = ({
  ...
  useAnimatedReaction(() => currentIndex.value, newIndex => scheduleOnRN(changeIndex, newIndex), [currentIndex, changeIndex]);
  useEffect(() => {
